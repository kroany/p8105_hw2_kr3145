...
| zip_code | neighborhood                  | county   |     2020 |     2021 | difference |
|---------:|:------------------------------|:---------|---------:|---------:|-----------:|
...
observations. The `difference` variable is included to represent the
ZORI difference between 2020 to 2021, by calculating ZORI in 2020 minus
ZORI in 2021. This means the larger and more positive the `difference`
